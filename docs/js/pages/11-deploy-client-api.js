...
发起rpc调用时，会随机选择一个游戏服节点，所有游戏服读取的是同一个数据库。
<table>
...
客户端通过http服务获取对外服列表，客户端自己选择连接哪个对外服，对外服收到客户端的登录请求及后续消息，发起rpc调用时，由于本进程内有游戏服节点，会优先本进程处理消息，客户端的消息永远在本进程内处理。
每个游戏服可以配置不同的数据库，实现数据隔离。
<table>
<thead><tr><th>节点类型</th><th>部署方式</th></tr></thead>
<tbody>
<tr><td>中心服</td><td>部署一个中心服，一个进程</td></tr>
